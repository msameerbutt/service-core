    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'author' => App\GraphQL\Queries\AuthorQuery::class,
                'authors' => App\GraphQL\Queries\AuthorsQuery::class,
                'article' => App\GraphQL\Queries\ArticleQuery::class,
                'articles' => App\GraphQL\Queries\ArticlesQuery::class,
            ],
            'mutation' => [
                'updateWineColor' => App\GraphQL\Mutations\UpdateWineColorMutation::class,
                'updateAuthorEmail' => App\GraphQL\Mutations\UpdateAuthorEmailMutation::class
            ],
        ],
    ],
